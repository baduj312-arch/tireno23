      ...
      <div className="max-w-lg mx-auto w-full px-4 -mt-6 relative z-10">
        ...
        >
          <div className="flex items-center gap-2">
            ...
            <span className="text-white text-sm font-medium">En Route</span>
          </div>
              ...
              {steps.map((step, i) => (
                <div key={step.label} className="flex items-start gap-3 mb-4 last:mb-0">
                  <div className="flex flex-col items-center">
                    ...
                    {i < steps.length - 1 && (
                      <div className={`w-0.5 h-6 mt-1 ${step.done ? 'bg-tireno-green' : 'bg-white/[0.06]'}`} />
                    )}
                  </div>
                  <div className="pt-0.5">
                    ...
                    {step.active && <span className="text-tireno-orange text-xs block mt-0.5">In progress</span>}
                  </div>
                </div>
              ))}
            </div>
